...
class AnalyticsService:
    ...
    def cargar_datos(self):
        """Cargar datos con cache interna - OPTIMIZADO"""
    ...
    def generar_analisis_rendimiento(_self):
        """Generar análisis de rendimiento académico CON CACHE"""
        try:
    ...
    def analizar_factores_riesgo(_self):
        """Analizar factores de riesgo CON CACHE"""
        try:
    ...
    def obtener_tendencia_calificaciones(_self):
        """Obtener tendencia de calificaciones por unidad CON CACHE"""
        try:
            df_calificaciones = _self.df_calificaciones
    ...
    def obtener_estadisticas_avanzadas(_self):
        """Obtener estadísticas avanzadas para herramientas estadísticas CON CACHE"""
        try:
            df_calificaciones = _self.df_calificaciones
    ...
    def generar_matriz_correlacion(_self, variables):
        """Generar matriz de correlación entre variables CON CACHE"""
        ...
        try:
            ...
            if len(variables_existentes) < 2:
                fig, ax = plt.subplots(figsize=(8, 6))
                ax.text(0.5, 0.5, 'Se necesitan al menos 2 variables', 
                       ha='center', va='center', transform=ax.transAxes, fontsize=14)
                return fig
    ...
    def generar_grafico_barras_carreras(_self):
        """Generar gráfico de barras por carreras CON CACHE"""
        import matplotlib.pyplot as plt
        ...
        try:
            ...
            if df_estudiantes.empty:
                ...
                ax.text(0.5, 0.5, 'No hay datos de estudiantes', 
                       ha='center', va='center', transform=ax.transAxes, fontsize=14)
                return fig
    ...
    def generar_grafico_tasas_por_carrera(_self):
        """Generar gráfico de tasas por carrera CON CACHE"""
        import matplotlib.pyplot as plt
        ...
        try:
            ...
            for carrera_id in datos_combinados['carrera_id'].unique():
                ...
                if len(datos_carrera) > 0:
                    tasa_reprobacion = datos_carrera['reprobado'].mean() * 100
            ...
            if not tasas_por_carrera:
                fig, ax = plt.subplots(figsize=(8, 6))
                ax.text(0.5, 0.5, 'No hay datos para calcular tasas', 
                       ha='center', va='center', transform=ax.transAxes, fontsize=14)
                return fig
    ...
    def generar_grafico_pareto(_self):
        """Generar datos para gráfico de Pareto de factores de riesgo CON CACHE"""
        try:
            df_factores = _self.df_factores
    ...
    def obtener_datos_para_analisis_visual(_self):
        """Obtener datos combinados para análisis visual CON CACHE"""
        try:
            df_calificaciones = _self.df_calificaciones
